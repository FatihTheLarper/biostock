  ...
  return (
    <div className="w-full px-4 py-4 font-sans min-h-screen">
      ...
      <main id="hero-section" className="flex flex-col md:flex-row items-center justify-center w-full p-6 md:p-12 mt-5 mb-8 md:mt-8 md:mb-8 gap-8 md:gap-16 rounded-2xl bg-linear-to-br from-green-600 via-green-700 to-green-800 dark:from-green-800 dark:via-green-900 dark:to-green-950 text-white shadow-xl">
        ...
        <div id="tagline" className="flex flex-col justify-center items-center text-lg md:text-2xl lg:text-3xl max-w-2xl">

          <h1 className="w-full text-center mb-4">Welcome to BioStock, where your ingredients become</h1>
          <ReactTyped
            className="text-xl md:text-3xl lg:text-4xl mb-8 text-center font-semibold bg-clip-text text-transparent bg-linear-to-r from-red-300 via-green-300 to-blue-300 dark:from-red-500 dark:via-green-400 dark:to-blue-500"
            strings={[
