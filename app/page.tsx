...
export default function Home() {
  ...
  return (
    <div className="w-full p-4 font-sans">
      ...
      <main id="hero-section" className="flex flex-col md:flex-row items-center justify-center w-full p-4 md:py-10 my-20 sm:space-x-10 lg:space-x-20 xl:space-x-40 2xl:space-x-60 rounded-xl bg-green-700 dark:bg-green-900 text-white">
