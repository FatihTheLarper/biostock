...
const About = () => {
  ...
  return (
    <div className="w-full p-4 font-sans min-h-screen">
      ...
      <main className="flex flex-col items-center justify-center w-full p-8 md:p-14 my-8 rounded-2xl bg-gradient-to-br from-green-600 via-green-700 to-green-800 dark:from-green-800 dark:via-green-900 dark:to-green-950 text-white shadow-xl">
